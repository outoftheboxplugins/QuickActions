...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuBuildAutomationExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuBuildAutomationExtension::GetCommands);
