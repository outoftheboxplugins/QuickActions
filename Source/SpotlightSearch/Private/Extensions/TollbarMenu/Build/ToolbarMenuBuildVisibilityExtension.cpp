...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuBuildVisibilityExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuBuildVisibilityExtension::GetCommands);
