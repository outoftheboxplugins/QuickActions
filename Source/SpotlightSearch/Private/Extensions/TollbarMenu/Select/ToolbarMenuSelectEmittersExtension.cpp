...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuSelectEmittersExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuSelectEmittersExtension::GetCommands);
