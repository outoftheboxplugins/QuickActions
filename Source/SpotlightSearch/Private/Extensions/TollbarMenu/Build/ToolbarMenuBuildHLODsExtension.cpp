...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuBuildHLODsExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuBuildHLODsExtension::GetCommands);
