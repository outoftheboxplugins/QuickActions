...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuSelectMaterialsExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuSelectMaterialsExtension::GetCommands);
