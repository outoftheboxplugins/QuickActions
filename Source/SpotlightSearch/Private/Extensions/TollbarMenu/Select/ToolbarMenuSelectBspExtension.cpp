...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuSelectBspExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuSelectBspExtension::GetCommands);
