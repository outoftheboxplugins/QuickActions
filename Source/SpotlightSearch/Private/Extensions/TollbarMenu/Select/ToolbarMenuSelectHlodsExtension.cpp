...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuSelectHlodsExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuSelectHlodsExtension::GetCommands);
