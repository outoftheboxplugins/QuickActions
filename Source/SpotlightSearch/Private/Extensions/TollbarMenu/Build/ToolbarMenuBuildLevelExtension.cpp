...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuBuildLevelExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuBuildLevelExtension::GetCommands);
