...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuBuildGeometryExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuBuildGeometryExtension::GetCommands);
