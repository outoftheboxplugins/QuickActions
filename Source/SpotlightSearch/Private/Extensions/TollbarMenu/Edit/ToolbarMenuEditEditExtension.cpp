...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuEditEditExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuEditEditExtension::GetCommands);
