...
TArray<TSharedPtr<FQuickCommandEntry>> UToolbarMenuSelectLightsExtension::GetCommands(const FQuickCommandContext& Context)
{
	TRACE_CPUPROFILER_EVENT_SCOPE(UToolbarMenuSelectLightsExtension::GetCommands);
